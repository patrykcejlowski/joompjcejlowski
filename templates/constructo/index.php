...
<div id="wrapper">
	...
	<?php if($this->countModules('top1') or $this->countModules('top2') or $this->countModules('top3')) : ?>
		<div id="top" class="clearfix">
			<div class="top1 hvr-rectangle-out"><jdoc:include type="modules" name="top1" style="xhtml" /></div>
			<div class="top2 hvr-rectangle-out"><jdoc:include type="modules" name="top2" style="xhtml" /></div>
			<div class="top3 hvr-rectangle-out"><jdoc:include type="modules" name="top3" style="xhtml" /></div>			
		</div>
	<?php endif; ?><?php endif; ?>		
