<jdoc:include type="head" />
 <!--[if lte IE 9]><link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/ie/ie8.css" type="text/css" /><![endif]-->
<!--[if IE]><link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/ie/ie.css" type="text/css" /><![endif]-->
